    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.TimeField(blank=True, help_text='Leave blank if this is a whole day use common area', null=True, verbose_name='User will start to use the common area at:')),
                ('end_time', models.TimeField(blank=True, help_text='Leave blank if this is a whole day use common area', null=True, verbose_name='User will end to use the common area at:')),
